...
class GetPopularMoviesUseCase implements BaseUseCase<List<MoviesEntities> , NoParam>{
  final MoviesRepositoryDomain moviesRepositoryDomain;

  GetPopularMoviesUseCase({required this.moviesRepositoryDomain});

  @override
  Future<Either<Failure , List< MoviesEntities >>> call(NoParam noParam)async{
    return await moviesRepositoryDomain.getPopularMovies();
  }
}